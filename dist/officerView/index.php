        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div id="box1">
                        <center>
                            <div  style="margin-top:10%; width: 60%; background-color:rgb(235, 235, 235)" height="auto">
                                <div class="form-row shadow-lg p-3 mb-5 bg-white rounded">
                                    <!--for scanner-->
                                    <div class="col-md-6" >
                                        <div  class="container-fluid" id="scanner" >
                                            <video id="preview" class="p-1 border" style="width: 70%; margin-top:3%" height="auto"> </video>
                                            <label class="small">Kindly align the QR code to the Camera</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-row container-fluid">
                                            <div class="col-md-12  container-fluid" style="margin-top:10%">
                                                <button class="btn btn-primary" style="width: 70%; " data-toggle="modal" data-target="#logInModal" data-backdrop="static" data-keyboard="false" onclick="btnLoginModal()">Log-in Driver</button>
                                                <label class="small">(For those who have an existing license but doesn't have the QR Code)</label>
                                            </div>
                                            <div class="col-md-12  container-fluid" style="margin-top:10%">
                                                <a href="noLicenseTicket.php"><button class="btn btn-primary"  style="width: 70%; ">Issue a ticket</button></a>
                                                <label class="small">(Only for those who doesn't have an existing license)</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="logInDriver" class="btn btn-primary" onclick="btnLoginDriver()">Log-in</button>
                                    </div>
                                </div>
                            </div>
                        </div>
