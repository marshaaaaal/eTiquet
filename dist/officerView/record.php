...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index.html">eTiquet</a>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <!--table for drivers with license-->
                <div class="container-fluid" style="background-color: rgb(235, 235, 235);">
                    <h1 class="mt-4">With driver's license List</h1>
...
<!----------------------------------------------------------------------------------------------------------------------------------->
                <!--table for without drivers licene-->
                <div class="container-fluid" style="background-color: rgb(235, 235, 235);">
                    <h1 class="mt-4">No driver's License List</h1>
